...
class llama_model:
    ...
    def _pdf_file_save_selection(self, pdf_file, s_c_ce_type, board_type=None, state_board=None, class_name=None, college_name=None, stream_name=None, subject_name=None) -> Dict:
        """Saves the PDF file in S3 Bucket if it does not already exist."""
        bucket_name = constants.BUCKETNAME
        if s_c_ce_type == "school":
            ...
            file_name = f"{s_c_ce_type}_{college_name}_{stream_name}_{subject_name}_{pdf_file.name}"
    ...
    def _get_answer_to_query(self, query, data):
        try:
            ...
            retriever = self._vectorstore_retriever(data)
...
#                         template="""You are an assistant for question-answering tasks. \n
#                         Treat as a Question , regardless of punctuation. \n
#                         Only provide the Answer Based on Question. \n
